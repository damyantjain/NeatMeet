...
//        labelDescription.lineBreakMode = .byWordWrapping
    ...
    func initConstraints() {
        NSLayoutConstraint.activate([
            ...
            labelLikeCount.leadingAnchor.constraint(equalTo: likeButton.trailingAnchor, constant: 2),
            labelLikeCount.trailingAnchor.constraint(lessThanOrEqualTo: contentWrapper.trailingAnchor, constant: -20),
            labelLikeCount.bottomAnchor.constraint(lessThanOrEqualTo: contentWrapper.bottomAnchor, constant: -32)
